package com.videocompress.compressvideo;
...
public class VideoCompress {
    ...
    public static VideoCompressTask compressVideo(String srcPath, String destPath, String qualityStr, CompressListener listener){
        int quality = VideoController.COMPRESS_QUALITY_LOW;
        switch (qualityStr){
            case "LOW": quality= VideoController.COMPRESS_QUALITY_LOW;
                break;
            case "MEDIUM": quality= VideoController.COMPRESS_QUALITY_MEDIUM;
                break;
            case "HIGH": quality= VideoController.COMPRESS_QUALITY_HIGH;
                break;
        }
        Log.d(TAG, "QUALITY STR: "+qualityStr);
        Log.d(TAG, "QUALITY STR: "+quality);
